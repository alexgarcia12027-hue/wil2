...
import { FaUser, FaEnvelope, FaPhone, FaIdCard, FaMapMarkerAlt, FaEdit, FaKey, FaLock } from 'react-icons/fa';
          ...
          <div>
            ...
            <div className="mt-10 pt-6 border-t border-gray-200">
              <h3 className="text-lg font-medium text-gray-900 mb-4 flex items-center">
                <FaLock className="mr-2 text-blue-500" /> Seguridad de la cuenta
              </h3>
