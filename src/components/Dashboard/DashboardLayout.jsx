...
import { FaHome, FaUser, FaFileAlt, FaComment, FaCalendarAlt, FaBook, FaCoins, FaUsers, FaCreditCard, FaSignOutAlt, FaLock, FaChartLine } from 'react-icons/fa';
...
const DashboardLayout = () => {
  ...
  const adminNavLinks = [
    { name: 'Panel Admin', path: '/dashboard/admin', icon: <FaLock /> },
