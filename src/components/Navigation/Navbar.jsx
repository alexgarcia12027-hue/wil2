...
import { FaUsers, FaHandshake, FaComments, FaGavel, FaBook, FaLock, FaFileContract, FaFileAlt, FaUserTie, FaWhatsapp, FaPhone, FaEnvelope, FaUserPlus, FaSignInAlt, FaLock, FaHome, FaShoppingCart, FaGraduationCap, FaNewspaper, FaBars, FaTimes, FaChevronDown, FaUser, FaSearch, FaMoon, FaSun, FaTrash } from 'react-icons/fa';
...
const policySubmenu = [
  { name: 'Política de Privacidad', href: '/privacidad', current: false, icon: <FaLock className="text-gray-500" /> },
