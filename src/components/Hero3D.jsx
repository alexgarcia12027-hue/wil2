...
import { FaWhatsapp, FaCalendarAlt, FaArrowRight, FaUserTie, FaLock, FaFileContract, FaClock } from 'react-icons/fa';
...
const Hero3D = () => {
  ...
  return (
    <div 
      ref={heroRef}
      className="relative bg-gradient-to-br from-primary-900 via-primary-800 to-blue-900 overflow-hidden"
      style={{
        perspective: '1000px',
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="pt-12 pb-20 sm:pt-16 sm:pb-24 lg:pt-20 lg:pb-28">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
                <Link
                  to="/contacto"
                  className="bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-bold py-3 px-6 rounded-lg text-lg transition-colors duration-300 shadow-lg inline-flex items-center justify-center transform hover:scale-105 hover:shadow-xl transition-transform"
                >
                  Consulta Gratis
                ...
                <a 
                  ...
                  className="flex-1 bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-lg flex items-center justify-center transition-all transform hover:scale-105 hover:shadow-xl"
                >
                ...
                <Link 
                  to="/calendario" 
                  className="flex-1 bg-white hover:bg-blue-50 text-primary-700 font-bold py-3 px-6 rounded-lg flex items-center justify-center transition-all transform hover:scale-105 hover:shadow-xl"
                >
            ...
            {/* Columna de tarjetas de servicios con efectos 3D */}
            <div className="lg:w-full">
              ...
              >
                {featuredServices.map((service, index) => (
                  <motion.div
                    key={service.id}
                    className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-5 hover:bg-white/20 transition-all group relative overflow-hidden"
                  ...
                  >
                    ...
                    <Link to={service.link} className="flex flex-col h-full relative z-10">
                      <div className="flex items-center mb-3">
                        <div className="p-2 rounded-lg bg-primary-700 mr-3 transform group-hover:scale-110 transition-transform">
                          {service.icon}
                        </div>
                      ...
                      <div className="mt-auto pt-3 border-t border-white/10 flex justify-between items-center">
                        ...
                        <div className="bg-white/20 rounded-full p-1 group-hover:bg-primary-700 transition-all transform group-hover:rotate-45">
                ...
                {/* Tarjeta de estadísticas con efecto de cristal 3D */}
                <motion.div 
                  className="md:col-span-2 bg-gradient-to-r from-primary-700/80 to-primary-800/80 border border-primary-600/50 rounded-xl p-5 backdrop-blur-lg relative overflow-hidden"
                  variants={itemVariants}
                  whileHover={{
                    scale: 1.02,
                ...
                >
                  ...
                  <div 
                    ...
                    style={{
                      background: `radial-gradient(300px circle at ${mousePosition.x / 8}px ${mousePosition.y / 8}px, rgba(255,255,255,0.3), transparent 40%)`,
                    }}
                  />
          ...
          {/* Oferta de tiempo limitado con efectos 3D */}
          <motion.div 
            className="bg-white/10 backdrop-blur-sm rounded-xl p-4 mb-8 border border-white/20 relative overflow-hidden"
            variants={itemVariants}
            whileHover={{
              y: -5,
              transition: { duration: 0.3 }
          ...
          >
            {/* Efecto de brillo en la tarjeta de oferta */}
            <div 
              className="absolute inset-0 opacity-10 pointer-events-none"
              style={{
                background: `radial-gradient(400px circle at ${mousePosition.x / 6}px ${mousePosition.y / 6}px, rgba(255,255,255,0.4), transparent 40%)`,
              }}
            />
            ...
            <div className="relative z-10">
              ...
              <div className="flex justify-center space-x-4 mb-3">
                <div className="flex flex-col items-center">
                  <div className="bg-primary-700 text-white rounded-md px-3 py-2 font-mono text-xl font-bold transform hover:scale-110 transition-transform">
                    {countdown.days}
                  </div>
              ...
              <Link 
                to="/contacto" 
                className="w-full bg-gradient-to-r from-yellow-500 to-yellow-400 hover:from-yellow-400 hover:to-yellow-300 text-primary-900 font-bold py-3 px-6 rounded-lg flex items-center justify-center transition-all duration-300 transform hover:scale-105 hover:shadow-lg"
              >
